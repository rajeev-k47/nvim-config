return {

  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>cpp", ":CompetiTest recieve problem<CR>", { desc = "Fetch a problem" })
      vim.keymap.set("n", "<leader>cpc", ":CompetiTest recieve contest<CR>", { desc = "Fetch contest" })
    end,
  },
}
